...

  {
    ...
    products: [ 
      ...
      { 
        ...
        rating: '4/5', 
        likes: 56,
        description: 'Триммер для бороды и усов, для бровей, для окантовки, для стрижки, универсальное. Значение минимальной длины стрижки1.0 мм \n Значение максимальной длины стрижки 8.0 мм \n Настройка длины стрижки сменой насадок \n Число установок длины 4', 
      }, 
      { 
        id: 7, 
        name: 'Серьги Золото', 
    ...
    //       id: 2, 
    //       name: 'Наушники Sony', 
    //       imageUrl: 'https://resources.cdn-kaspi.kz/img/m/p/h92/h7b/84007811776542.jpg?format=gallery-large', 
    //       imageUrl1: 'https://resources.cdn-kaspi.kz/img/m/p/h5f/h69/84007811907614.jpg?format=gallery-large', 
    //       imageUrl2: 'https://resources.cdn-kaspi.kz/img/m/p/h44/hae/84007811842078.jpg?format=gallery-large', 
    //       buyUrl: 'https://kaspi.kz/shop/p/sony-wfc700nv-e-fioletovyi-113516619/?c=750000000&ref=shared_link', 
    //       price: '39 990 ₸', 
    //       rating: '5/5', 
    ...
    //       id: 10, 
    //       name: 'Телевизор Yasin ', 
    //       imageUrl: 'https://resources.cdn-kaspi.kz/img/m/p/had/h96/68005513363486.jpg?format=gallery-large', 
    //       buyUrl: 'https://kaspi.kz/shop/p/yasin-43g11-109-sm-chernyi-108494502/?c=750000000&ref=shared_link', 
    //       price: '96 000 ₸', 
    //       rating: '4,5/5', 
    //       description: 'тип: LED-телевизор, диагональ: 43.0 дюйм , разрешение: 1366x768 , поддержка HD: 1080p Full HD , технология Smart TV: Да , wi-Fi: Да , входы: AV ,HDMI, ,USB, ,Bluetooth', 
    //     }, 
    //     { 
    //       id: 11, 
    //       name: "Wi-Fi роутер TELE2", 
    ...
    //   id: 2,
    //   title: "1000 игрушек",
    //   // categoryType: categoryTypeProducts
    // },
    // {
    //   id: 3,
    //   title: "1000 ухода",
...
//   id: number;
//   title: string;
//   categoryType: CategoryTypeItems[];
// }

// export interface CategoryTypeItems {
//   id: number;
//   name: string;
//   imageUrl1?: string;
//   imageUrl2?: string;
...
// export const categoryTypeProducts = [ 
//   { 
